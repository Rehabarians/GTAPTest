...
let PlayerPos;
let InteriorID;
let HangerMenu = API.createMenu("Hanger customiser", 0, 0, 6);
let HangerBedroomMenu = API.createMenu("Bedroom Decor", 0, 0, 6);
let HangerMainLightingMenu = API.createMenu("Hanger Main Lighting", 0, 0, 6);
let HangerWallLightingMenu = API.createMenu("Hanger Wall Lighting", 0, 0, 6);
let HangerFloorMenu = API.createMenu("Hanger Floor Design", 0, 0, 6);
let FloorTypeMenu = API.createMenu("Floor Type", "", 0, 0, 6);
let FloorDecalMenu = API.createMenu("Floor Decal", "", 0, 0, 6);
let HangerOfficeMenu = API.createMenu("Office Decor", 0, 0, 6);
let BlindListItem;
let ClutterCheckItem;
let BedroomIntListItem;
let HangerMainLightingItem;
let MainLightingString = ["Type A", "Type B", "Type C"];
let HangerWallLightingItem;
let WallLightingString = [
    "Neutral",
    "Tint 1",
    "Tint 2",
    "Tint 3",
...
let HangerFloorTypeItem;
let HangerFloorDecalItem;
let FloorTypeString = [
    "Type 1",
    "Type 2",
];
let FloorDecalString = [
    "Decal 1",
    "Decal 2",
    "Decal 3",
    "Decal 4",
...
let HangerOfficeItem;
let OfficeString = ["Basic", "Modern", "Traditional"];
    ...
    switch (index) {
        case 0:
            for (var i = 0; i < WallLightID.length; i++) {
                let ispropenabled = API.isInteriorPropEnabled(InteriorID, WallLightID[i]);
    ...
    switch (index) {
        case 0:
            for (var i = 0; i < FloorDecalID.length; i++) {
                let ispropenabled = API.isInteriorPropEnabled(InteriorID, FloorDecalID[i]);
                if (ispropenabled === true) {
                    API.disableInteriorProp(InteriorID, WallLightID[i]);
                }
            }
