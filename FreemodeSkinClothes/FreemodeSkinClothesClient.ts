...
let MainMenu: NativeUI.UIMenu = API.createMenu("Clothes Menu", 0, 0, 6);
let MainMenuItems;
let MainMenuNames: string[] = [
    "Hats",
    "Earrings",
    "Glasses",
    "Mask",
...
let HatsMenu: NativeUI.UIMenu = API.createMenu("Hats", 0, 0, 6);
let HatsMenuItems: NativeUI.UIMenuListItem;
let HatCurrentVariation: number;
let HatCurrentTexture: number;
let HatsVariationSelected: number;
let HatsTextureSelected: number;
let HatSelectedBool: boolean;

let EarringsMenu: NativeUI.UIMenu = API.createMenu("Earrings", 0, 0, 6);
let EarringsMenuItems;
let EarringsCurrentVariation: number;
let EarringsCurrentTexture: number;
let EarringsVariationSelected: number;
let EarringsTextureSelected: number;
let EarringSelectedBool: boolean;

let GlassesMenu: NativeUI.UIMenu = API.createMenu("Glasses", 0, 0, 6);
let GlassesMenuItems;
let GlassesCurrentVariation: number;
let GlassesCurrentTexture: number;
let GlassesVariationSelected: number;
let GlassesTextureSelected: number;
let GlassesSelectedBool: boolean;

let MasksMenu: NativeUI.UIMenu = API.createMenu("Mask", 0, 0, 6);
let MaskMenuItems;
let MaskCurrentVariation: number;
let MaskCurrentTexture: number;
let MasksVariationSelected: number;
let MasksTextureSelected: number;
let MaskSelectedBool: boolean;

let NecksMenu: NativeUI.UIMenu = API.createMenu("Neck Accessories", 0, 0, 6);
let NecksMenuItems;
let NeckCurrentVariation: number;
let NeckCurrentTexture: number;
let NecksVariationSelected: number;
let NecksTextureSelected: number;
let NeckSelectedBool: boolean;

let TopsMenu: NativeUI.UIMenu = API.createMenu("Tops", 0, 0, 6);
let TopsMenuItems;
let TopCurrentVariation: number;
let TopCurrentTexture: number;
let TopsVariationSelected: number;
let TopsTextureSelected: number;
let TopSelectedBool: boolean;

let UndershirtsMenu: NativeUI.UIMenu = API.createMenu("Undershirts", 0, 0, 6);
let UndershirtsMenuItems;
let UndershirtCurrentVariation: number;
let UndershirtCurrentTexture: number;
let UndershirtsVariationSelected: number;
let UndershirtsTextureSelected: number;
let UndershirtSelectedBool: boolean;

let WatchesMenu: NativeUI.UIMenu = API.createMenu("Watches", 0, 0, 6);
let WatchesMenuItems;
let WatchCurrentVariation: number;
let WatchCurrentTexture: number;
let WatchesVariationSelected: number;
let WatchesTextureSelected: number;
let WatchSelectedBool: boolean;

let BraceletsMenu: NativeUI.UIMenu = API.createMenu("Braclets", 0, 0, 6);
let BraceletsMenuItems;
let BraceletCurrentVariation: number;
let BraceletCurrentTexture: number;
let BraceletsVariationSelected: number;
let BraceletsTextureSelected: number;
let BraceletSelectedBool: boolean;

let GlovesMenu: NativeUI.UIMenu = API.createMenu("Gloves", 0, 0, 6);
let GlovesMenuItems;
let GlovesCurrentVariation: number;
let GlovesCurrentTexture: number;
let GlovesVariationSelected: number;
let GlovesTextureSelected: number;
let GlovesSelectedBool: boolean;

let TorsoSelected: number;

let TrousersMenu: NativeUI.UIMenu = API.createMenu("Trousers", 0, 0, 6);
let TrousersMenuItems;
let TrousersCurrentVariation: number;
let TrousersCurrentTexture: number;
let TrousersVariationSelected: number;
let TrousersTextureSelected: number;
let TrouserSelectedBool: boolean;

let ShoesMenu: NativeUI.UIMenu = API.createMenu("Shoes", 0, 0, 6);
let ShoesMenuItems;
let ShoesCurrentVariation: number;
let ShoesCurrentTexture: number;
let ShoesVariationSelected: number;
let ShoesTextureSelected: number;
let ShoesSelectedBool: boolean;
