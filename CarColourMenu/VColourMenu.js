...
let MainMenu = API.createMenu("Main Menu", 0, 0, 6);
let MainMenuItems;
let Colour1Menu = API.createMenu("Primary Colour", 0, 0, 6);
let Colour1Item;
let PearlescentMenu = API.createMenu("Pearlescent Colour", 0, 0, 6);
let PearlescentItem;
let Colour2Menu = API.createMenu("Secondary Colour", 0, 0, 6);
let Colour2Item;
let BlackPrimMenu = API.createMenu("Black Colours", 0, 0, 6);
let BlackPearlMenu = API.createMenu("Black Colours", 0, 0, 6);
let BlackSecMenu = API.createMenu("Black Colours", 0, 0, 6);
let RedPrimMenu = API.createMenu("Red Colours", 0, 0, 6);
let RedPearlMenu = API.createMenu("Red Colours", 0, 0, 6);
let RedSecMenu = API.createMenu("Red Colours", 0, 0, 6);
let GreenPrimMenu = API.createMenu("Green Colours", 0, 0, 6);
let GreenPearlMenu = API.createMenu("Green Colours", 0, 0, 6);
let GreenSecMenu = API.createMenu("Green Colours", 0, 0, 6);
let BluePrimMenu = API.createMenu("Blue Colours", 0, 0, 6);
let BluePearlMenu = API.createMenu("Blue Colours", 0, 0, 6);
let BlueSecMenu = API.createMenu("Blue Colours", 0, 0, 6);
let BrownPrimMenu = API.createMenu("Brown Colours", 0, 0, 6);
let BrownPearlMenu = API.createMenu("Brown Colours", 0, 0, 6);
let BrownSecMenu = API.createMenu("Brown Colours", 0, 0, 6);
let WhitePrimMenu = API.createMenu("White Colours", 0, 0, 6);
let WhitePearlMenu = API.createMenu("White Colours", 0, 0, 6);
let WhiteSecMenu = API.createMenu("White Colours", 0, 0, 6);
let MetalPrimMenu = API.createMenu("Metal Paints", 0, 0, 6);
let MetalPearlMenu = API.createMenu("Metal Paints", 0, 0, 6);
let MetalSecMenu = API.createMenu("Metal Paints", 0, 0, 6);
let PinkPrimMenu = API.createMenu("Pink Colours", 0, 0, 6);
let PinkPearlMenu = API.createMenu("Pink Colours", 0, 0, 6);
let PinkSecMenu = API.createMenu("Pink Colours", 0, 0, 6);
let PurplePrimMenu = API.createMenu("Purple Colours", 0, 0, 6);
let PurplePearlMenu = API.createMenu("Purple Colours", 0, 0, 6);
let PurpleSecMenu = API.createMenu("Purple Colours", 0, 0, 6);
let YellowPrimMenu = API.createMenu("Yellow Colours", 0, 0, 6);
let YellowPearlMenu = API.createMenu("Yellow Colours", 0, 0, 6);
let YellowSecMenu = API.createMenu("Yellow Colours", 0, 0, 6);
let OrangePrimMenu = API.createMenu("Orange Colours", 0, 0, 6);
let OrangePearlMenu = API.createMenu("Orange Colours", 0, 0, 6);
let OrangeSecMenu = API.createMenu("Orange Colours", 0, 0, 6);
let MainMenuItemNames = [
    "Primary Colour",
    "Pearlescent Colour",
    "Secondary Colour"
];
